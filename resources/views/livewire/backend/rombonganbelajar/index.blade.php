                    ...
                    <div class="box-header with-border">
                        <div class="mb-2 row">
                            <div class="mb-2 col-xl-3 col-lg-3 col-md-3 col-12">
                                ...
                                <a class="btn btn-sm btn-primary ms-3"  href="{{ route('backend.rombonganbelajar.create')}}" style="pointer='cursor';">
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($datarombonganbelajar as $no =>  $item)
                                            <tr>
                                ...
                                <div class="mt-3 row">
                                    <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                        @if ($datarombonganbelajar->total() > 10)
                                        {{ $datarombonganbelajar->links() }}
                                        @else
                                        Page : {{ $datarombonganbelajar->currentPage() }} | Show {{ $datarombonganbelajar->count() }} data
                                        of {{ $datarombonganbelajar->total() }}
                                        @endif
                                    </div>
