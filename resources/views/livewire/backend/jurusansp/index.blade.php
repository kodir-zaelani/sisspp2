                    ...
                    <div class="box-header with-border">
                        <div class="mb-2 row">
                            <div class="mb-2 col-xl-3 col-lg-3 col-md-3 col-12">
                                ...
                                <a class="btn btn-sm btn-primary ms-3"  href="{{ route('backend.jurusansp.create')}}" style="pointer='cursor';">
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($datajurusansp as $no =>  $item)
                                            <tr>
                                                <th class="text-right" scope="row">{{ $no + $datajurusansp->firstItem() }}</th>
                                                <td>
                                                    {{ !empty($item->sekolah_id) ? $item->sekolah->nama:'' }}
                                                </td>
                                                <td>
                                                    {{ !empty($item->jurusan_id) ? $item->jurusan->nama_jurusan:'' }}
                                                </td>
                                                {{-- <td>
                                ...
                                <div class="mt-3 row">
                                    <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                        @if ($datajurusansp->total() > 10)
                                        {{ $datajurusansp->links() }}
                                        @else
                                        Page : {{ $datajurusansp->currentPage() }} | Show {{ $datajurusansp->count() }} data
                                        of {{ $datajurusansp->total() }}
                                        @endif
                                    </div>
