...
<body class="fixed layout-top-nav light-skin theme-primary">
    ...
    <div class="wrapper">
        @include('backend.partials.header-horizontal')
        ...
        @include('backend.partials.footer-horizontal')
    </div>

    <script data-navigate-once src="{{ asset('') }}assets/wali/js/vendors.min.js"></script>
    @stack('scripts')
    <script data-navigate-once src="{{ asset('') }}assets/wali/js/jquery.smartmenus.js"></script>
	<script data-navigate-once src="{{ asset('') }}assets/wali/js/menus.js"></script>
    ...
    <script>
        ...
        window.addEventListener('closeCheckoutModal', event => {
         ...
         window.addEventListener('openDeleteModalAll', event => {
            $("#modalFormDeleteAll").modal('show');
        });
