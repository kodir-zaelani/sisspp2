...
<body>
    ...
    <div
    class="bottom-0 mb-3 dropdown position-fixed end-0 me-3 bd-mode-toggle"
    >
    <button
    class="py-2 btn btn-bd-primary dropdown-toggle d-flex align-items-center"
    id="bd-theme"
    type="button"
    aria-expanded="false"
...
<ul
class="shadow dropdown-menu dropdown-menu-end"
...
<nav class="navbar navbar-expand-md fixed-top bg-body-tertiary">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a class="btn btn-outline-primary ms-2" href="{{route('login')}}">
            Login
        </a>
    </div>
</div>
