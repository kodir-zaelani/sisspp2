...
<div class="p-2 mt-1 mb-4 text-center rounded text-body-emphasis">
...
<div class="row g-5">
    <div class="col-md-4">
        <div class="position-sticky text-body-emphasis" style="top: 2rem">
            <div>
                <h4 class="fw-bold">Panduan</h4>
                <ol class="mb-0 list-unstyled">
                    <li><a href="#" class="text-decoration-none text-body-emphasis">Halaman Login</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">Daftar Akun</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">Dashboard Orang Tua</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">December 2020</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">November 2020</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">October 2020</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">September 2020</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">August 2020</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">July 2020</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">June 2020</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">May 2020</a></li>
                    <li><a href="#" class="text-decoration-none text-body-emphasis">April 2020</a></li>
                </ol>
            </div>
        </div>
    </div>
    <div class="col-md-8">
        ...
        <article class="blog-post">
            <h2 class="mb-1 display-5 link-body-emphasis">Sample blog post</h2>
        ...
        <article class="blog-post">
            <h2 class="mb-1 display-5 link-body-emphasis">Another blog post</h2>
            <p class="blog-post-meta">
        ...
        <article class="blog-post">
            <h2 class="mb-1 display-5 link-body-emphasis">New feature</h2>
            <p class="blog-post-meta">
