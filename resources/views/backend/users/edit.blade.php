                        ...
                        <div class="col-md-12">
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="selectedDistrict">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="selectedSekolah">
                            ...
                            @if ($user->masterstatus == config('cms.default_masteruser'))
                            <div class="form-group">
                                <label for="current_password_for_password">Current Password <span
