                        ...
                        <li class="treeview">
                            <a href="#">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="{{ setActive('backend/transaksi/list') }}">
                                        <a href="{{ route('backend.transaksi.list') }}">
                                            <i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>
                                            Daftar Transaksi
                                        </a>
                                    </li>
                        ...
                        <li class="treeview {{ setActive('backend/tahunajaran') . setActive('backend/semester') }} {{ setOpen('backend/tahunajaran') . setOpen('backend/semester')}}">
                            <a href="#">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    @endcan
                                    {{-- @can('pesertadidik.index') --}}
                                    <li class="{{ setActive('backend/pesertadidik') }}">
                                        <a href="{{ route('backend.pesertadidik.index') }}">
                                            <i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>
                                            Peserta Didik
                                        </a>
                                    </li>
