        ...
        <div class="col-12 col-lg-7 col-xl-8">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li><a class="active" href="#usertimeline" data-bs-toggle="tab">Timeline</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="active tab-pane" id="usertimeline">
                        <div class="bg-white publisher publisher-multi b-1 mb-30">
                        ...
                        <div class="box b-1 no-shadow">
                            <div class="media bb-1 border-fade">
                                <img class="avatar avatar-lg" src="{{ asset('') }}assets/images/avatar/3.jpg" alt="...">
                            ...
                            <div class="media-list media-list-divided bg-lighter">
                                ...
                                <div class="media">
                                    <a class="avatar" href="#">
                                        <img src="{{ asset('') }}assets/images/avatar/9.jpg" alt="...">
                                    </a>
                                    <div class="media-body">
                                        <p>
                            ...
                            <form class="publisher bt-1 border-fade">
                                <img class="avatar avatar-sm" src="{{ asset('') }}assets/images/avatar/4.jpg" alt="...">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-body">
                                            <img src="{{ asset('') }}assets/images/150x100.png" alt="..." class="m-10">
                                            <img src="{{ asset('') }}assets/images/150x100.png" alt="..." class="m-10">
                                            <img src="{{ asset('') }}assets/images/150x100.png" alt="..." class="m-10">
                                            <img src="{{ asset('') }}assets/images/150x100.png" alt="..." class="m-10">
                                        </div>
                        ...
                        <div class="box no-shadow">
                            <div class="post">
                                <div class="user-block">
                                    <img class="img-bordered-sm rounded-circle" src="{{ asset('') }}assets/images/user1-128x128.jpg" alt="user image">
                                    <span class="username">
                                        <a href="#">Brayden</a>
                                ...
                                <div class="activitytimeline">
                                    ...
                                    <ul class="list-inline">
                                        <li><a href="#" class="text-sm link-black"><i class="fa fa-share margin-r-5"></i> Share</a></li>
                                        <li><a href="#" class="text-sm link-black"><i class="fa fa-thumbs-o-up margin-r-5"></i> Like</a>
                                        </li>
                                        <li class="pull-right">
                                            <a href="#" class="text-sm link-black"><i class="fa fa-comments-o margin-r-5"></i> Comments
                                                (5)</a></li>
                                            </ul>
                                    ...
                                    <div class="post">
                                        <div class="user-block">
                                            <img class="img-bordered-sm rounded-circle" src="{{ asset('') }}assets/images/user6-128x128.jpg" alt="user image">
                                            <span class="username">
                                                <a href="#">Evan</a>
                                                <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                                            </span>
                                        ...
                                        <div class="activitytimeline">
                                            <div class="mb-20 row">
                                                <div class="col-sm-6">
                                                    <img class="img-fluid" src="{{ asset('') }}assets/images/photo1.png" alt="Photo">
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <img class="img-fluid" src="{{ asset('') }}assets/images/photo2.png" alt="Photo">
                                                            <br><br>
                                                            <img class="img-fluid" src="{{ asset('') }}assets/images/photo3.jpg" alt="Photo">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <img class="img-fluid" src="{{ asset('') }}assets/images/photo4.jpg" alt="Photo">
                                                            <br><br>
                                                            <img class="img-fluid" src="{{ asset('') }}assets/images/photo1.png" alt="Photo">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="clearfix post">
                                                <div class="user-block">
                                                    <img class="img-bordered-sm rounded-circle" src="{{ asset('') }}assets/images/user7-128x128.jpg" alt="user image">
                                                    <span class="username">
                                                        <a href="#">Nicholas</a>
                                                        <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                                                    </span>
                        ...
                        <div class="col-12 col-lg-5 col-xl-4">
                            <div class="box box-widget widget-user">
                                <div class="widget-user-header bg-img bbsr-0 bber-0" style="background: url('{{ asset('') }}assets/images/gallery/full/10.jpg') center center;" data-overlay="5">
                                    <h3 class="text-white widget-user-username">Michael Jorden</h3>
                                    <h6 class="text-white widget-user-desc">Designer</h6>
                                </div>
                            ...
                            <div class="box box-inverse" style="background-color: #3b5998">
                                ...
                                <blockquote class="m-0 blockquote blockquote-inverse no-border py-15">
