...
class SemesterResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('tahunajaran_id')
                    ->required()
                    ->maxLength(36),
                Forms\Components\TextInput::make('semesterid')
                    ->required()
                    ->maxLength(5),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('tahunajaran_id')
                    ->searchable(),
                Tables\Columns\TextColumn::make('semesterid')
                    ->searchable(),
